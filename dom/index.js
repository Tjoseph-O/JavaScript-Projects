...
// function removeGroceries(table, grocery, price){
//     let groceryRow = document.createElement("tr");
//
//
//     let groceryData = document.createElement("td");
...
//     priceData.innerText = price;
//
//     groceryRow.removeChild(groceryData);
//     groceryRow.removeChild(priceData);
//
//     table.childNodes[1].removeChild(groceryRow);
//
// }
// function remove() {
//     event.preventDefault();
